...
#endif
#ifdef SIMULATION
#include "kf32a13k_reg_simulation_bpt.h"
#define BPT_MODULE_BASE_ADDR 0xF0020400U
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CLKC_BPT0_CLKC_DISR_MASK;
    regValue |= Status << HWIO_BPT0_CLKC_BPT0_CLKC_DISR_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CLKC_ADDR, regValue);
...
KF_INLINE bool Bpt_LL_GetModuleStatus(BPT_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CLKC_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_CLKC_BPT0_CLKC_DISS_MASK;
    regValue = regValue >> HWIO_BPT0_CLKC_BPT0_CLKC_DISS_SHFT;
    return ((regValue));
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetSleepModeDisabled(BPT_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CLKC_BPT0_CLKC_EDIS_MASK;
    regValue |= Status << HWIO_BPT0_CLKC_BPT0_CLKC_EDIS_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CLKC_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_INFO_BPT0_INFO_MODREV_MASK;
    regValue = regValue >> HWIO_BPT0_INFO_BPT0_INFO_MODREV_SHFT;
    return ((regValue));
    // TODO: check if correct
...
KF_INLINE uint32_t Bpt_LL_GetModuleType(const BPT_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_INFO_BPT0_INFO_MODTYPE_MASK;
    regValue = regValue >> HWIO_BPT0_INFO_BPT0_INFO_MODTYPE_SHFT;
    return ((regValue));
    // TODO: check if correct
...
KF_INLINE uint32_t Bpt_LL_GetModuleNumber(const BPT_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_INFO_BPT0_INFO_MODNUM_MASK;
    regValue = regValue >> HWIO_BPT0_INFO_BPT0_INFO_MODNUM_SHFT;
    return ((regValue));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_DBG_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_DBG_BPT0_DBG_SUSSTA_MASK;
    regValue = regValue >> HWIO_BPT0_DBG_BPT0_DBG_SUSSTA_SHFT;
    return ((regValue));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    regValue.reg        = REG_READ(HWIO_BPT0_DBG_ADDR + offsetAddr);
    regValue.bits.SUSP  = true;
    regValue.bits.SUS   = SuspendMode;
    REG_WRITE(offsetAddr + HWIO_BPT0_DBG_ADDR, regValue.reg);
    // TODO: check if correct
#else
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_RST0_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_RST0_BPT0_RST0_RST_MASK;
    regValue |= 1U << HWIO_BPT0_RST0_BPT0_RST0_RST_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_RST0_ADDR, regValue);
    // TODO: check if correct
...
#endif
#ifdef SIMULATION
    offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    regValue   = REG_READ(HWIO_BPT0_RST1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_RST1_BPT0_RST1_RST_MASK;
    regValue |= 1U << HWIO_BPT0_RST1_BPT0_RST1_RST_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_RST1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_RSTCLR_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_RSTCLR_BPT0_RSTCLR_CLR_MASK;
    regValue |= 1U << HWIO_BPT0_RSTCLR_BPT0_RSTCLR_CLR_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_RSTCLR_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE bool Bpt_LL_GetResetStatus(const BPT_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_RST0_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_RST0_BPT0_RST0_RSTSTA_MASK;
    regValue = regValue >> HWIO_BPT0_RST0_BPT0_RST0_RSTSTA_SHFT;
    return ((regValue));
    // TODO: check if correct
...
#ifdef SIMULATION
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_BPT0_ACES0_ADDR + offsetAddr);
        regValue &= ~(1U << Id);
        regValue |= ((uint32_t)Status << Id);

        REG_WRITE(offsetAddr + HWIO_BPT0_ACES0_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_BPT0_ACES1_ADDR + offsetAddr);
        regValue &= ~(1U << (Id - BPT_MASTER_TAG_ID32));
        regValue |= ((uint32_t)Status << (Id - BPT_MASTER_TAG_ID32));
        REG_WRITE(offsetAddr + HWIO_BPT0_ACES1_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_EN_MASK;
    regValue |= Status << HWIO_BPT0_CTL1_BPT0_CTL1_EN_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetCounterManner(BPT_RegisterMap_t *const Module, const Bpt_CountingManner_t Manner)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_CMS_MASK;
    regValue |= Manner << HWIO_BPT0_CTL1_BPT0_CTL1_CMS_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetCounterSource(BPT_RegisterMap_t *const Module, const Bpt_CountingSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_CLKSMUX_MASK;
    regValue |= Source << HWIO_BPT0_CTL1_BPT0_CTL1_CLKSMUX_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_EnableSinglePulseMode(BPT_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_SPM_MASK;
    regValue |= Status << HWIO_BPT0_CTL1_BPT0_CTL1_SPM_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetSinglePulseMode(BPT_RegisterMap_t *const Module, const Bpt_SinglePulseMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_SPMST_MASK;
    regValue |= Mode << HWIO_BPT0_CTL1_BPT0_CTL1_SPMST_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_EnableMasterSlaveModeSync(BPT_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_MSSYNC_MASK;
    regValue |= Status << HWIO_BPT0_CTL1_BPT0_CTL1_MSSYNC_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SelectSlaveMode(BPT_RegisterMap_t *const Module, const Bpt_SlaveMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_SMS_MASK;
    regValue |= Mode << HWIO_BPT0_CTL1_BPT0_CTL1_SMS_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SelectTriggerInputSource(BPT_RegisterMap_t *const Module, const Bpt_TriggerInputSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_TRGIS_MASK;
    regValue |= Source << HWIO_BPT0_CTL1_BPT0_CTL1_TRGIS_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SelectTriggerOutputSource(BPT_RegisterMap_t *const Module, const Bpt_TriggerOutputSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL1_BPT0_CTL1_TRGOS_MASK;
    regValue |= Source << HWIO_BPT0_CTL1_BPT0_CTL1_TRGOS_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL2_BPT0_CTL2_TXUDEN_MASK;
    regValue |= Status << HWIO_BPT0_CTL2_BPT0_CTL2_TXUDEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL2_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetTimerUpdateEventMode(BPT_RegisterMap_t *const Module, Bpt_TimerUpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL2_BPT0_CTL2_TXUDEVT_MASK;
    regValue |= Mode << HWIO_BPT0_CTL2_BPT0_CTL2_TXUDEVT_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL2_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Bpt_LL_SetTimerUpdateImmediately(BPT_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_CTL2_BPT0_CTL2_TXUR_MASK;
    regValue |= 1U << HWIO_BPT0_CTL2_BPT0_CTL2_TXUR_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_CTL2_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_BPT0_CNT_ADDR, Value);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_BPT0_PRSC_ADDR, Prescale);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_BPT0_PPX_ADDR, Period);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    return (REG_READ(offsetAddr + HWIO_BPT0_PPX_ADDR));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    return (REG_READ(offsetAddr + HWIO_BPT0_CNT_ADDR));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_UDTIM_ADDR + offsetAddr);
    regValue &= ~HWIO_BPT0_UDTIM_BPT0_UDTIM_UDCNT_MASK;
    regValue |= Counter << HWIO_BPT0_UDTIM_BPT0_UDTIM_UDCNT_SHFT;
    REG_WRITE(offsetAddr + HWIO_BPT0_UDTIM_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_STA_ADDR + offsetAddr);
    regValue &= HWIO_BPT0_STA_BPT0_STA_DIR_MASK;
    regValue = regValue >> HWIO_BPT0_STA_BPT0_STA_DIR_SHFT;
    return (Bpt_CountingDirection_t)((regValue));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    return (bool)(REG_BITS_READ(offsetAddr + HWIO_BPT0_IF_ADDR, (1U << (uint32_t)Index), ((uint32_t)Index)));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_IE_ADDR + offsetAddr);
    regValue &= ~(1U << (uint32_t)Index);
    regValue |= ((uint32_t)Status << (uint32_t)Index);

    REG_WRITE(offsetAddr + HWIO_BPT0_IE_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_IC_ADDR + offsetAddr);
    regValue |= (1U << (uint32_t)Index);

    REG_WRITE(offsetAddr + HWIO_BPT0_IC_ADDR, regValue);
#else
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~BPT_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_BPT0_IS_ADDR + offsetAddr);
    regValue |= (1U << (uint32_t)Index);

    REG_WRITE(offsetAddr + HWIO_BPT0_IS_ADDR, regValue);
#else
