...
#include "kf32a13k_reg_simulation_psi5.h"
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_CLKC_ADDR );
    regValue &= ~HWIO_PSI5_CLKC_PSI5_CLKC_DISR_MASK;
    regValue |=  Status<<HWIO_PSI5_CLKC_PSI5_CLKC_DISR_SHFT;
    REG_WRITE(HWIO_PSI5_CLKC_ADDR , regValue);
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_CLKC_ADDR );
    regValue &= ~HWIO_PSI5_CLKC_PSI5_CLKC_EDIS_MASK;
    regValue |=  Status<<HWIO_PSI5_CLKC_PSI5_CLKC_EDIS_SHFT;
    REG_WRITE(HWIO_PSI5_CLKC_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_DBG_ADDR );
    regValue &= ~HWIO_PSI5_DBG_PSI5_DBG_DBGP_MASK;
    regValue |=  true<<HWIO_PSI5_DBG_PSI5_DBG_DBGP_SHFT;
    REG_WRITE(HWIO_PSI5_DBG_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_DBG_ADDR );
    regValue &= ~HWIO_PSI5_DBG_PSI5_DBG_DBGCTL_MASK;
    regValue |=  SuspendMode<<HWIO_PSI5_DBG_PSI5_DBG_DBGCTL_SHFT;
    REG_WRITE(HWIO_PSI5_DBG_ADDR , regValue);
//TODO: check if correct
    ...
    uint32_t regValue=REG_READ(HWIO_PSI5_DBG_ADDR );
    regValue &= ~HWIO_PSI5_DBG_PSI5_DBG_DBGP_MASK;
    regValue |=  false<<HWIO_PSI5_DBG_PSI5_DBG_DBGP_SHFT;
    REG_WRITE(HWIO_PSI5_DBG_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_ResetModule(const bool Status)
{
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_BOOL(Status));
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RST0_ADDR );
    regValue &= ~HWIO_PSI5_RST0_PSI5_RST0_RST_MASK;
    regValue |=  Status<<HWIO_PSI5_RST0_PSI5_RST0_RST_SHFT;
    REG_WRITE(HWIO_PSI5_RST0_ADDR , regValue);
//TODO: check if correct
...
#endif
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RST1_ADDR );
    regValue &= ~HWIO_PSI5_RST1_PSI5_RST1_RST_MASK;
    regValue |=  Status<<HWIO_PSI5_RST1_PSI5_RST1_RST_SHFT;
    REG_WRITE(HWIO_PSI5_RST1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_FDRT_ADDR );
    regValue &= ~HWIO_PSI5_FDRT_PSI5_FDRT_STEP_MASK;
    regValue |=  PreScale<<HWIO_PSI5_FDRT_PSI5_FDRT_STEP_SHFT;
    REG_WRITE(HWIO_PSI5_FDRT_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_FDRT_ADDR );
    regValue &= ~HWIO_PSI5_FDRT_PSI5_FDRT_DVIMOD_MASK;
    regValue |=  DivisionMode<<HWIO_PSI5_FDRT_PSI5_FDRT_DVIMOD_SHFT;
    REG_WRITE(HWIO_PSI5_FDRT_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_FDRT_ADDR );
    regValue &= ~HWIO_PSI5_FDRT_PSI5_FDRT_ECS_MASK;
    regValue |=  ExternalTrigger<<HWIO_PSI5_FDRT_PSI5_FDRT_ECS_SHFT;
    REG_WRITE(HWIO_PSI5_FDRT_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_FDRT_ADDR );
    regValue &= ~HWIO_PSI5_FDRT_PSI5_FDRT_ECEA_MASK;
    regValue |=  Status<<HWIO_PSI5_FDRT_PSI5_FDRT_ECEA_SHFT;
    REG_WRITE(HWIO_PSI5_FDRT_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_EnableExternalTimeStampClear(Psi5_TimeStampChannel_t TimeStampChannel, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_BOOL(Status));
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_FDRT_ADDR ,                    (Status << (POS_29_SHIFT + TimeStampChannel)));//TODO: check if correct
...
#ifdef SIMULATION
//TODO: Error: cannot find the correct registerHWIO_PSI5_DBG_PSI5_DBG_DBGCTL_MASK with bit RSIFSOURCE name please correct
#else
...
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_DBG_PSI5_DBG_DBGCTL_MASK ,                    ((uint32_t)Status << (TriggerChannel + POS_8_OFFSET)));//TODO: check if correct
...
KF_INLINE void Psi5_LL_EnableTriggerChannel(const Psi5_TriggerChannelType_t TriggerChannel, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_TRIGGERCHANNEL(TriggerChannel));
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_DBG_PSI5_DBG_DBGCTL_MASK ,                    ((uint32_t)Status << (TriggerChannel + POS_16_OFFSET)));//TODO: check if correct
...
#ifdef SIMULATION
    return (REG_BITS_READ(HWIO_PSI5_GIF_ADDR, MASK_1_BIT << Flag, Flag));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_IOCTL0_ADDR );
    regValue &= ~HWIO_PSI5_IOCTL0_PSI5_IOCTL0_INSEL_MASK;
    regValue |=  Input<<HWIO_PSI5_IOCTL0_PSI5_IOCTL0_INSEL_SHFT;
    REG_WRITE(HWIO_PSI5_IOCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_IOCTL0_ADDR );
    regValue &= ~HWIO_PSI5_IOCTL0_PSI5_IOCTL0_DEPTH_MASK;
    regValue |=  Depth<<HWIO_PSI5_IOCTL0_PSI5_IOCTL0_DEPTH_SHFT;
    REG_WRITE(HWIO_PSI5_IOCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_IOCTL0_ADDR );
    regValue &= ~HWIO_PSI5_IOCTL0_PSI5_IOCTL0_OPOLSEL_MASK;
    regValue |=  Status<<HWIO_PSI5_IOCTL0_PSI5_IOCTL0_OPOLSEL_SHFT;
    REG_WRITE(HWIO_PSI5_IOCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_IOCTL0_ADDR );
    regValue &= ~HWIO_PSI5_IOCTL0_PSI5_IOCTL0_IPOLSEL_MASK;
    regValue |=  Status<<HWIO_PSI5_IOCTL0_PSI5_IOCTL0_IPOLSEL_SHFT;
    REG_WRITE(HWIO_PSI5_IOCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_IOCTL0_ADDR );
    regValue &= ~HWIO_PSI5_IOCTL0_PSI5_IOCTL0_CREGF_MASK;
    regValue |=  Status<<HWIO_PSI5_IOCTL0_PSI5_IOCTL0_CREGF_SHFT;
    REG_WRITE(HWIO_PSI5_IOCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_RCTLA0_ADDR ,                    DataLength << (FrameIndex * POS_5_SHIFT));//TODO: check if correct
...
KF_INLINE void Psi5_LL_EnableAsynMode(Psi5_ChannelType_t Channel, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLA0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLA0_PSI5_RCTLA0_ASYNEN_MASK;
    regValue |=  Status<<HWIO_PSI5_RCTLA0_PSI5_RCTLA0_ASYNEN_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLA0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLA0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLA0_PSI5_RCTLA0_AVBSEN_MASK;
    regValue |=  Status<<HWIO_PSI5_RCTLA0_PSI5_RCTLA0_AVBSEN_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLA0_ADDR , regValue);
//TODO: check if correct
...
Psi5_LL_EnableMsgBit(Psi5_ChannelType_t Channel, const Psi5_FrameIndexType_t FrameIndex, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_FRAMEINDEX(FrameIndex));
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_RCTLB0_ADDR ,                    Status << (FrameIndex * POS_4_SHIFT));//TODO: check if correct
...
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_RCTLB0_ADDR ,                    ParityCheckMode << (FrameIndex * POS_4_SHIFT + POS_1_OFFSET));//TODO: check if correct
...
Psi5_LL_SetFrameException(Psi5_ChannelType_t Channel, const Psi5_FrameIndexType_t FrameIndex, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_FRAMEINDEX(FrameIndex));
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_RCTLB0_ADDR ,                    Status << (FrameIndex * POS_4_SHIFT + POS_2_OFFSET));//TODO: check if correct
...
Psi5_LL_SetRedundanceMode(Psi5_ChannelType_t Channel, const Psi5_FrameIndexType_t FrameIndex, const bool Status)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_FRAMEINDEX(FrameIndex));
#ifdef SIMULATION
    REG_BITS_WRITE(HWIO_PSI5_RCTLB0_ADDR ,                    Status << (FrameIndex * POS_4_SHIFT + POS_3_OFFSET));//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLC0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLC0_PSI5_RCTLC0_BRSEL_MASK;
    regValue |=  BaudRateType<<HWIO_PSI5_RCTLC0_PSI5_RCTLC0_BRSEL_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLC0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLC0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSPSEL_MASK;
    regValue |=  TimeStampChannel<<HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSPSEL_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLC0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLC0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSFSEL_MASK;
    regValue |=  TimeStampChannel<<HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSFSEL_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLC0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_RCTLC0_ADDR );
    regValue &= ~HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSRSEL_MASK;
    regValue |=  TimeStampType<<HWIO_PSI5_RCTLC0_PSI5_RCTLC0_TSRSEL_SHFT;
    REG_WRITE(HWIO_PSI5_RCTLC0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_TBSEL_MASK;
    regValue |=  TimerBase<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_TBSEL_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETBSEL_MASK;
    regValue |=  ExternalTimerBase<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETBSEL_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_PTEN_MASK;
    regValue |=  Status<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_PTEN_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETSEL_MASK;
    regValue |=  ExternalTriggerSource<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETSEL_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETEN_MASK;
    regValue |=  Status<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_ETEN_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_BYP_MASK;
    regValue |=  Status<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_BYP_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_PCTRL0_ADDR );
    regValue &= ~HWIO_PSI5_PCTRL0_PSI5_PCTRL0_BOT_MASK;
    regValue |=  IdleTime<<HWIO_PSI5_PCTRL0_PSI5_PCTRL0_BOT_SHFT;
    REG_WRITE(HWIO_PSI5_PCTRL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_CTV0_ADDR );
    regValue &= ~HWIO_PSI5_CTV0_PSI5_CTV0_CTV_MASK;
    regValue |=  Count<<HWIO_PSI5_CTV0_PSI5_CTV0_CTV_SHFT;
    REG_WRITE(HWIO_PSI5_CTV0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_CTV0_ADDR );
    regValue &= ~HWIO_PSI5_CTV0_PSI5_CTV0_CTCNT_MASK;
    regValue |=  Count<<HWIO_PSI5_CTV0_PSI5_CTV0_CTCNT_SHFT;
    REG_WRITE(HWIO_PSI5_CTV0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_PLLEN_MASK;
    regValue |=  DataLength<<HWIO_PSI5_SCTL0_PSI5_SCTL0_PLLEN_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_EPSEL_MASK;
    regValue |=  Version<<HWIO_PSI5_SCTL0_PSI5_SCTL0_EPSEL_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_BSCTL_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_BSCTL_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_SSLEN_MASK;
    regValue |=  DataLength<<HWIO_PSI5_SCTL0_PSI5_SCTL0_SSLEN_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_FLUS_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_FLUS_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_FLUO_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_FLUO_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_CRCCTRL_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_CRCCTRL_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_STACTRL_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_STACTRL_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_INH_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_INH_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t regValue=REG_READ(HWIO_PSI5_SCTL0_ADDR );
    regValue &= ~HWIO_PSI5_SCTL0_PSI5_SCTL0_GO_MASK;
    regValue |=  Status<<HWIO_PSI5_SCTL0_PSI5_SCTL0_GO_SHFT;
    REG_WRITE(HWIO_PSI5_SCTL0_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteSendDataLow(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SDRL0_ADDR ,  Data);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteSendDataHigh(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SDRH0_ADDR ,  Data);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteShiftDataLow(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SSRL0_ADDR ,  Data);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteShiftDataHigh(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SSRH0_ADDR ,  Data);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteOutputDataLow(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SORL0_ADDR ,  Data);
//TODO: check if correct
...
KF_INLINE void Psi5_LL_WriteOutputDataHigh(Psi5_ChannelType_t Channel, uint32_t Data)
{
    ...
    KF_DRV_PSI5_ASSERT(CHECK_PSI5_CHANNEL(Channel));
#ifdef SIMULATION
    REG_WRITE(HWIO_PSI5_SORH0_ADDR ,  Data);
//TODO: check if correct
