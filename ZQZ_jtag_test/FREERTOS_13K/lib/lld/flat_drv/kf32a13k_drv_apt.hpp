...
#endif
#ifdef SIMULATION
#include "kf32a13k_reg_simulation_apt.h"
#define APT_MODULE_BASE_ADDR 0xF0021000
#endif
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CLKC_APT0_CLKC_DISR_MASK;
    regValue |=  Status<<HWIO_APT0_CLKC_APT0_CLKC_DISR_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CLKC_ADDR , regValue);
...
KF_INLINE bool Apt_LL_GetModuleStatus(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CLKC_ADDR + offsetAddr);
    regValue &= HWIO_APT0_CLKC_APT0_CLKC_DISS_MASK;
    regValue = regValue >> HWIO_APT0_CLKC_APT0_CLKC_DISS_SHFT;
    return ((regValue));
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetSleepModeEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CLKC_APT0_CLKC_EDIS_MASK;
    regValue |=  Status<<HWIO_APT0_CLKC_APT0_CLKC_EDIS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CLKC_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_APT0_INFO_APT0_INFO_MODREV_MASK;
    regValue = regValue >> HWIO_APT0_INFO_APT0_INFO_MODREV_SHFT;
    return ((regValue));
//TODO: check if correct
...
KF_INLINE uint32_t Apt_LL_GetModuleType(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_APT0_INFO_APT0_INFO_MODTYPE_MASK;
    regValue = regValue >> HWIO_APT0_INFO_APT0_INFO_MODTYPE_SHFT;
    return ((regValue));
//TODO: check if correct
...
KF_INLINE uint32_t Apt_LL_GetModuleNumber(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_INFO_ADDR + offsetAddr);
    regValue &= HWIO_APT0_INFO_APT0_INFO_MODNUM_MASK;
    regValue = regValue >> HWIO_APT0_INFO_APT0_INFO_MODNUM_SHFT;
    return ((regValue));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_DBG_ADDR + offsetAddr);
    regValue &= HWIO_APT0_DBG_APT0_DBG_SUSSTA_MASK;
    regValue = regValue >> HWIO_APT0_DBG_APT0_DBG_SUSSTA_SHFT;
    return ((regValue));
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetSuspendMode(Apt_RegisterMap_t *const Module, const Apt_SuspendMode_t SuspendMode)
{
    ...
    APT_DBG_T regValue = {0U};

#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    regValue.reg        = REG_READ(HWIO_APT0_DBG_ADDR + offsetAddr);
    regValue.bits.SUSP  = true;
    regValue.bits.SUS   = SuspendMode;
    REG_WRITE(offsetAddr + HWIO_APT0_DBG_ADDR, regValue.reg);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_RST0_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_RST0_APT0_RST0_RST_MASK;
    regValue |=  1U<<HWIO_APT0_RST0_APT0_RST0_RST_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_RST0_ADDR , regValue);
//TODO: check if correct
...
#endif
#ifdef SIMULATION
     offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
     regValue=REG_READ(HWIO_APT0_RST1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_RST1_APT0_RST1_RST_MASK;
    regValue |=  1U<<HWIO_APT0_RST1_APT0_RST1_RST_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_RST1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_RSTCLR_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_RSTCLR_APT0_RSTCLR_CLR_MASK;
    regValue |=  1U<<HWIO_APT0_RSTCLR_APT0_RSTCLR_CLR_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_RSTCLR_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE bool Apt_LL_GetResetStatus(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_RST0_ADDR + offsetAddr);
    regValue &= HWIO_APT0_RST0_APT0_RST0_RSTSTA_MASK;
    regValue = regValue >> HWIO_APT0_RST0_APT0_RST0_RSTSTA_SHFT;
    return ((regValue));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_EN_MASK;
    regValue |=  Status<<HWIO_APT0_T1CTL1_APT0_T1CTL1_EN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetCounterManner(Apt_RegisterMap_t *const Module, const Apt_CountingManner_t Manner)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_CMS_MASK;
    regValue |=  Manner<<HWIO_APT0_T1CTL1_APT0_T1CTL1_CMS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetCounterSource(Apt_RegisterMap_t *const Module, const Apt_CountingSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_CLKMUX_MASK;
    regValue |=  Source<<HWIO_APT0_T1CTL1_APT0_T1CTL1_CLKMUX_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectSlaveMode(Apt_RegisterMap_t *const Module, const Apt_SlaveMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_SMS_MASK;
    regValue |=  Mode<<HWIO_APT0_T1CTL1_APT0_T1CTL1_SMS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectTriggerInputSource(Apt_RegisterMap_t *const Module, const Apt_TriggerInputSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_TRGIS_MASK;
    regValue |=  Source<<HWIO_APT0_T1CTL1_APT0_T1CTL1_TRGIS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectTriggerOutputSource(Apt_RegisterMap_t *const Module, const Apt_TriggerOutputSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_TRGOS_MASK;
    regValue |=  Source<<HWIO_APT0_T1CTL1_APT0_T1CTL1_TRGOS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SelectOverflowTriggerADMode(Apt_RegisterMap_t *const Module, const Apt_OverflowTriggerADMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL1_APT0_T1CTL1_OFS_MASK;
    regValue |=  Mode<<HWIO_APT0_T1CTL1_APT0_T1CTL1_OFS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_CCTEN_MASK;
    regValue |=  Status<<HWIO_APT0_T1CTL2_APT0_T1CTL2_CCTEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SelectComparatorRstTimerMode(Apt_RegisterMap_t *const Module, const Apt_ComparatorRstTimerMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_CRSET_MASK;
    regValue |=  Mode<<HWIO_APT0_T1CTL2_APT0_T1CTL2_CRSET_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SelectComparatorForRstTimer(Apt_RegisterMap_t *const Module, const Apt_ComparatorModule_t Comparator)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_CCTSEL_MASK;
    regValue |=  Comparator<<HWIO_APT0_T1CTL2_APT0_T1CTL2_CCTSEL_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetExternClockInputFilterEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKFEN_MASK;
    regValue |=  Status<<HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKFEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SetExternClockFilterDivide(Apt_RegisterMap_t *const Module, const Apt_ExternClockInputFilterDivide_t Divide)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKDIV_MASK;
    regValue |=  Divide<<HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKDIV_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SetExternClockFilterDelay(Apt_RegisterMap_t *const Module, const Apt_ExternClockInputFilterDelay_t Delay)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKDELAY_MASK;
    regValue |=  Delay<<HWIO_APT0_T1CTL2_APT0_T1CTL2_TCKDELAY_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CTL2_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_MASK;
    regValue |=  Status<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectPhaseReloadMode(Apt_RegisterMap_t *const Module, const Apt_PhaseReloadMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSMODE_MASK;
    regValue |=  Mode<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSMODE_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetSoftwareTriggerPhaseReload(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSW_MASK;
    regValue |=  Status<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSW_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectPhaseReloadTiming(Apt_RegisterMap_t *const Module, const Apt_PhaseReloadTiming_t Timing)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSSEL_MASK;
    regValue |=  Timing<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSSEL_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetPhaseReloadPrescale(Apt_RegisterMap_t *const Module, const Apt_PhaseReloadPrescale_t Prescale)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSPRSC_MASK;
    regValue |=  Prescale<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSPRSC_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetPhaseReloadTimes(Apt_RegisterMap_t *const Module, const Apt_PhaseReloadNumOfTimes_t Times)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSTIME_MASK;
    regValue |=  Times<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSTIME_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetPhaseReloadTimesControlEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSTIEN_MASK;
    regValue |=  Status<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSTIEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SetPhaseReloadDirection(Apt_RegisterMap_t *const Module, const Apt_PhaseReloadDirection_t Direction)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSDIR_MASK;
    regValue |=  Direction<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSDIR_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_APT0_T1CNT_ADDR ,  Value);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    return (REG_READ(offsetAddr + HWIO_APT0_T1CNT_ADDR));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_APT0_T1PRSC1_ADDR ,  Prescale);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PRSC2_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PRSC2_APT0_T1PRSC2_CKBS_MASK;
    regValue |=  Prescale<<HWIO_APT0_T1PRSC2_APT0_T1PRSC2_CKBS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PRSC2_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1PPX_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PPX_APT0_T1PPX_PPX_MASK;
    regValue |=  Period<<HWIO_APT0_T1PPX_APT0_T1PPX_PPX_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PPX_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE uint32_t Apt_LL_GetPeriod(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t regValue=REG_READ(HWIO_APT0_T1PPX_ADDR + offsetAddr);
    regValue &= HWIO_APT0_T1PPX_APT0_T1PPX_PPX_MASK;
    regValue = regValue >> HWIO_APT0_T1PPX_APT0_T1PPX_PPX_SHFT;
    return ((regValue));
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetPhase(Apt_RegisterMap_t *const Module, const uint32_t Phase)
{
    ...
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_MASK;
    regValue |=  Phase<<HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1PHSCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE uint32_t Apt_LL_GetPhase(const Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t regValue=REG_READ(HWIO_APT0_T1PHSCTL_ADDR + offsetAddr);
    regValue &= HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_MASK;
    regValue = regValue >> HWIO_APT0_T1PHSCTL_APT0_T1PHSCTL_PHSEN_SHFT;
    return ((regValue));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CCR0_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CCR0_APT0_T1CCR0_T1CCR0_MASK;
    regValue |=  Value<<HWIO_APT0_T1CCR0_APT0_T1CCR0_T1CCR0_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CCR0_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_T1CCR1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_T1CCR1_APT0_T1CCR1_T1CCR1_MASK;
    regValue |=  Value<<HWIO_APT0_T1CCR1_APT0_T1CCR1_T1CCR1_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_T1CCR1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEN_MASK;
    regValue |=  Status<<HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetT1CtrlRegUpdateEventMode(Apt_RegisterMap_t *const Module, Apt_TimerUpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEVT0_MASK;
    regValue |=  Mode<<HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEVT0_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetT1UpdateEventMode(Apt_RegisterMap_t *const Module, Apt_TimerUpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEVT1_MASK;
    regValue |=  Mode<<HWIO_APT0_UDCTL_APT0_UDCTL_T1UDEVT1_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetT1UpdateImmediately(Apt_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_T1UDR_MASK;
    regValue |=  1U<<HWIO_APT0_UDCTL_APT0_UDCTL_T1UDR_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetT1OverflowUpdateEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_T1OUDREN_MASK;
    regValue |=  Status<<HWIO_APT0_UDCTL_APT0_UDCTL_T1OUDREN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetTrigUpdateCtrlRegEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_TRGUDEN0_MASK;
    regValue |=  Status<<HWIO_APT0_UDCTL_APT0_UDCTL_TRGUDEN0_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetTrigUpdateEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_TRGUDEN1_MASK;
    regValue |=  Status<<HWIO_APT0_UDCTL_APT0_UDCTL_TRGUDEN1_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetTrigUpdateCtrlRegMode(Apt_RegisterMap_t *const Module, const Apt_TrigUpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_TUDMODE0_MASK;
    regValue |=  Mode<<HWIO_APT0_UDCTL_APT0_UDCTL_TUDMODE0_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetTrigUpdateMode(Apt_RegisterMap_t *const Module, const Apt_TrigUpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDCTL_APT0_UDCTL_TUDMODE1_MASK;
    regValue |=  Mode<<HWIO_APT0_UDCTL_APT0_UDCTL_TUDMODE1_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDCTL_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_UDTIM1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_UDTIM1_APT0_UDTIM1_UDCNT_MASK;
    regValue |=  Value<<HWIO_APT0_UDTIM1_APT0_UDTIM1_UDCNT_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_UDTIM1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL1_APT0_CHCTL1_HMEN_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL1_APT0_CHCTL1_HMEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetHallTemplateCompareEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL1_APT0_CHCTL1_HMPEN_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL1_APT0_CHCTL1_HMPEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetSinglePulseModeEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL1_APT0_CHCTL1_SPMEN_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL1_APT0_CHCTL1_SPMEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL1_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SelectSinglePulseMode(Apt_RegisterMap_t *const Module, Apt_SinglePulseMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL1_APT0_CHCTL1_SPMS_MASK;
    regValue |=  Mode<<HWIO_APT0_CHCTL1_APT0_CHCTL1_SPMS_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL3_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL3_APT0_CHCTL3_CAPTST_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL3_APT0_CHCTL3_CAPTST_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL3_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetGlobalTimeBaseEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL3_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL3_APT0_CHCTL3_GTBEN_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL3_APT0_CHCTL3_GTBEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL3_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_GetGlobalTimeBaseStatus(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CHCTL3_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CHCTL3_APT0_CHCTL3_GTBEOUT_MASK;
    regValue |=  Status<<HWIO_APT0_CHCTL3_APT0_CHCTL3_GTBEOUT_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CHCTL3_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_ASCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_ASCTL1_APT0_ASCTL1_RSEN_MASK;
    regValue |=  Status<<HWIO_APT0_ASCTL1_APT0_ASCTL1_RSEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_ASCTL1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_ZPDCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_ZPDCTL1_APT0_ZPDCTL1_ZCLK_MASK;
    regValue |=  Clock<<HWIO_APT0_ZPDCTL1_APT0_ZPDCTL1_ZCLK_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_ZPDCTL1_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_HPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_HPCTL_APT0_HPCTL_CURHP_MASK;
    regValue |=  Template<<HWIO_APT0_HPCTL_APT0_HPCTL_CURHP_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_HPCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetHallInputExpectTemplate(Apt_RegisterMap_t *const Module, Apt_HallTemplate_t Template)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_HPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_HPCTL_APT0_HPCTL_EXPHP_MASK;
    regValue |=  Template<<HWIO_APT0_HPCTL_APT0_HPCTL_EXPHP_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_HPCTL_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_DITCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_DITCTL_APT0_DITCTL_FRCVAL_MASK;
    regValue |=  Value<<HWIO_APT0_DITCTL_APT0_DITCTL_FRCVAL_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_DITCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetEdgeDitherEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_DITCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_DITCTL_APT0_DITCTL_DEDEN_MASK;
    regValue |=  Status<<HWIO_APT0_DITCTL_APT0_DITCTL_DEDEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_DITCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetPeriodicDitherEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_DITCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_DITCTL_APT0_DITCTL_DPEEN_MASK;
    regValue |=  Status<<HWIO_APT0_DITCTL_APT0_DITCTL_DPEEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_DITCTL_ADDR , regValue);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CCRCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR0SEN_MASK;
    regValue |=  Status<<HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR0SEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CCRCTL_ADDR , regValue);
//TODO: check if correct
...
KF_INLINE void Apt_LL_SetCCR1TrigAdEnabled(Apt_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CCRCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR1SEN_MASK;
    regValue |=  Status<<HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR1SEN_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CCRCTL_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SelectTxCcr0TrigAdCountDirection(Apt_RegisterMap_t *const Module, const Apt_CcrTrigAdDirection_t Dir)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CCRCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR0SEL_MASK;
    regValue |=  Dir<<HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR0SEL_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CCRCTL_ADDR , regValue);
//TODO: check if correct
...
Apt_LL_SelectTxCcr1TrigAdCountDirection(Apt_RegisterMap_t *const Module, const Apt_CcrTrigAdDirection_t Dir)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_CCRCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR1SEL_MASK;
    regValue |=  Dir<<HWIO_APT0_CCRCTL_APT0_CCRCTL_T1CCR1SEL_SHFT;
    REG_WRITE( offsetAddr + HWIO_APT0_CCRCTL_ADDR , regValue);
//TODO: check if correct
 ...
 *                APT_CHANNEL_3
 * @param Pin
 *                APT_CAPTURE_PIN_0 引脚0
 *                APT_CAPTURE_PIN_1 引脚1
 *                APT_CAPTURE_PIN_2 引脚2
 *                APT_CAPTURE_PIN_3 引脚3
 *                APT_CAPTURE_PIN_4 引脚4
 *                APT_CAPTURE_PIN_5 引脚5
 *                APT_CAPTURE_PIN_6 引脚6
 *                APT_CAPTURE_PIN_7 引脚7
 * @return
 */
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    uint32_t regValue=REG_READ(HWIO_APT0_DBG_APT0_DBG_SUSSTA_MASK + offsetAddr);
    regValue &= HWIO_APT0_STA_APT0_STA_T1DIR_MASK;
    regValue = regValue >> HWIO_APT0_STA_APT0_STA_T1DIR_SHFT;
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_APT0_C1_ADDR+ (uint32_t)Channel * 4);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_APT0_BC1_ADDR+ (uint32_t)Channel * 4);
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    return (REG_READ(offsetAddr + HWIO_APT0_R1_ADDR+(uint32_t)Channel*4));
//TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~APT_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_APT0_R1_ADDR + Channel*4 ,  Value);
//TODO: check if correct
 ...
 * @return
 */
KF_INLINE uint32_t Apt_LL_GetIntrFlag(Apt_RegisterMap_t *const Module, Apt_InterruptGetIndex_t Index)
{
    KF_DRV_APT_ASSERT(CHECK_APT_ALL_PERIPH(Module));
...
//TODO:REG_BITS_READ cannot process
#else
    return (REG_BITS_READ(Module->APT_IF.reg, (1U << (uint32_t)Index), (uint32_t)Index));
#endif
}
...
//TODO:
#else
    REG_BITS_WRITE(Module->APT_IS.reg, (3U << ((uint32_t)Index * 2)), ((uint32_t)Line << ((uint32_t)Index * 2)));
#endif
}
