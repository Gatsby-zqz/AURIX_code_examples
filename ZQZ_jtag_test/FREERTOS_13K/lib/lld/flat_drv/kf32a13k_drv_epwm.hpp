...
#endif
#ifdef SIMULATION
#include "kf32a13k_reg_simulation_epwm.h"
#define EPWM_MODULE_BASE_ADDR 0xF0024000
#endif
#ifdef __cplusplus
extern "C" {
#endif
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CLKC_EPWM11_CLKC_DISR_MASK;
    regValue |= Status << HWIO_EPWM11_CLKC_EPWM11_CLKC_DISR_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CLKC_ADDR, regValue);
...
KF_INLINE bool Epwm_LL_GetModuleStatus(const Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CLKC_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_CLKC_EPWM11_CLKC_DISS_MASK;
    regValue = regValue >> HWIO_EPWM11_CLKC_EPWM11_CLKC_DISS_SHFT;
    return (regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSleepModeDisabled(Epwm_RegisterMap_t *const Module, const bool Status)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CLKC_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CLKC_EPWM11_CLKC_EDIS_MASK;
    regValue |= Status << HWIO_EPWM11_CLKC_EPWM11_CLKC_EDIS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CLKC_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_INFO_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_INFO_EPWM11_INFO_MODREV_MASK;
    regValue = regValue >> HWIO_EPWM11_INFO_EPWM11_INFO_MODREV_SHFT;
    return (regValue);
    // TODO: check if correct
...
KF_INLINE uint32_t Epwm_LL_GetModuleType(const Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_INFO_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_INFO_EPWM11_INFO_MODTYPE_MASK;
    regValue = regValue >> HWIO_EPWM11_INFO_EPWM11_INFO_MODTYPE_SHFT;
    return (regValue);
    // TODO: check if correct
...
KF_INLINE uint32_t Epwm_LL_GetModuleNumber(const Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_INFO_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_INFO_EPWM11_INFO_MODNUM_MASK;
    regValue = regValue >> HWIO_EPWM11_INFO_EPWM11_INFO_MODNUM_SHFT;
    return (regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_DBG_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_DBG_EPWM11_DBG_SUSEPWMA_MASK;
    regValue = regValue >> HWIO_EPWM11_DBG_EPWM11_DBG_SUSEPWMA_SHFT;
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    regValue.reg        = REG_READ(HWIO_EPWM11_DBG_ADDR + offsetAddr);
    regValue.bits.SUSP  = true;
    regValue.bits.SUS   = SuspendMode;
    REG_WRITE(offsetAddr + HWIO_EPWM11_DBG_ADDR, regValue.reg);
    // TODO: check if correct
#else
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RST0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_RST0_EPWM11_RST0_RST_MASK;
    regValue |= 1U << HWIO_EPWM11_RST0_EPWM11_RST0_RST_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_RST0_ADDR, regValue);
    // TODO: check if correct
...
#endif
#ifdef SIMULATION
    offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    regValue   = REG_READ(HWIO_EPWM11_RST1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_RST1_EPWM11_RST1_RST_MASK;
    regValue |= 1U << HWIO_EPWM11_RST1_EPWM11_RST1_RST_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_RST1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RSTCLR_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_RSTCLR_EPWM11_RSTCLR_CLR_MASK;
    regValue |= 1U << HWIO_EPWM11_RSTCLR_EPWM11_RSTCLR_CLR_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_RSTCLR_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE bool Epwm_LL_GetResetStatus(const Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RST0_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK;
    regValue = regValue >> HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_SHFT;
    return (bool)(regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_ACES0_ADDR + offsetAddr);
    regValue &= ~(1U << Id);
    regValue |= ((uint32_t)Status << Id);

    REG_WRITE(offsetAddr + HWIO_EPWM11_ACES0_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_EN_MASK;
    regValue |= Status << HWIO_EPWM11_CTL0_EPWM11_CTL0_EN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetTimerWorkMode(Epwm_RegisterMap_t *const Module, const Epwm_TimerWorkMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_CS_MASK;
    regValue |= (uint32_t)Mode << HWIO_EPWM11_CTL0_EPWM11_CTL0_CS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct

#else
    REG_WRITE(Module->EPWM_CTL0.bits.CS, (uint32_t)Mode);
#endif
}
...
KF_INLINE void Epwm_LL_SetGatingEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_GATEEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_GATEEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetExternalPulseSyncEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_TXSY_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_TXSY_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SelectClockSource(Epwm_RegisterMap_t *const Module, const Epwm_ClockSource_t ClockSource)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_CLKSEL_MASK;
    regValue |= (uint32_t)ClockSource << HWIO_EPWM11_CTL0_EPWM11_CTL0_CLKSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct

#else
    REG_WRITE(Module->EPWM_CTL0.bits.CLKSEL, (uint32_t)ClockSource);
#endif
}
...
KF_INLINE void Epwm_LL_SetCounterManner(Epwm_RegisterMap_t *const Module, const Epwm_CountingManner_t Manner)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_CMS_MASK;
    regValue |= Manner << HWIO_EPWM11_CTL0_EPWM11_CTL0_CMS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetPhaseReloadEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SelectSyncOutputEvent(Epwm_RegisterMap_t *const Module, const Epwm_SyncEvent_t SelectedEvent)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_SYNCOSEL_MASK;
    regValue |= (uint32_t)SelectedEvent << HWIO_EPWM11_CTL0_EPWM11_CTL0_SYNCOSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct

#else
    REG_WRITE(Module->EPWM_CTL0.bits.SYNCOSEL, (uint32_t)SelectedEvent);
#endif
}
...
KF_INLINE void Epwm_LL_GenerateSoftwareSyncEvent(Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_SWFSYNC_MASK;
    regValue |= true << HWIO_EPWM11_CTL0_EPWM11_CTL0_SWFSYNC_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetPhaseReloadDirection(Epwm_RegisterMap_t *const Module, const Epwm_PhaseReloadDirection_t Direction)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSDIR_MASK;
    regValue |= Direction << HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSDIR_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetAQRegisterLockEnabled(Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_AQLOCKA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_AQLOCKA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_AQLOCKB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_AQLOCKB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
        // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetDBRegisterWriteDisabled(Epwm_RegisterMap_t *const Module, const bool DisableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_DBLOCK_MASK;
    regValue |= DisableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_DBLOCK_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetPCRegisterWriteDisabled(Epwm_RegisterMap_t *const Module, const bool DisableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_PCLOCK_MASK;
    regValue |= DisableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_PCLOCK_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetETRegisterWriteDisabled(Epwm_RegisterMap_t *const Module, const bool DisableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_ETLOCK_MASK;
    regValue |= DisableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_ETLOCK_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetHRRegisterWriteDisabled(Epwm_RegisterMap_t *const Module, const bool DisableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_HRLOCK_MASK;
    regValue |= DisableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_HRLOCK_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSyncSignalTriggerUpdate(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_UDSYNEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_UDSYNEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetLinkToUpperLevel(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL0_EPWM11_CTL0_BLINKEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL0_EPWM11_CTL0_BLINKEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SWCLRPF_MASK;
    regValue |= true << HWIO_EPWM11_CTL1_EPWM11_CTL1_SWCLRPF_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SWCLRPF_MASK;
    regValue |= false << HWIO_EPWM11_CTL1_EPWM11_CTL1_SWCLRPF_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetBlankWindowEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SelectBlankWindowPolarity(Epwm_RegisterMap_t *const Module, const Epwm_BlankWindowPolarity_t Polarity)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDPOL_MASK;
    regValue |= Polarity << HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDPOL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SelectBlankWindowReference(Epwm_RegisterMap_t *const Module, const Epwm_BlankWindowRef_t Reference)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDTSEL_MASK;
    regValue |= Reference << HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDTSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetDoubleDeadZoneEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_DUDBEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_DUDBEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SelectDoubleDeadZoneEdge(Epwm_RegisterMap_t *const Module, const Epwm_DeadZoneEdge_t Edge)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_DUDBSEL_MASK;
    regValue |= Edge << HWIO_EPWM11_CTL1_EPWM11_CTL1_DUDBSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSyncInputMode(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SYNCIOS_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_SYNCIOS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetTriggerSingleModeEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_TRGIOS_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_TRGIOS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSyncFilterEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SYNCFEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_SYNCFEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSyncFilterPrescale(Epwm_RegisterMap_t *const Module, Epwm_SyncFilterPrescale_t Prescale)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SYFDIV_MASK;
    regValue |= Prescale << HWIO_EPWM11_CTL1_EPWM11_CTL1_SYFDIV_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetSyncFilterDelay(Epwm_RegisterMap_t *const Module, Epwm_SyncFilterDelay_t Delay)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_SYDELAY_MASK;
    regValue |= Delay << HWIO_EPWM11_CTL1_EPWM11_CTL1_SYDELAY_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetExternClockFilterEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_CKFEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_CKFEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetExternClockFilterPrescale(Epwm_RegisterMap_t *const Module, Epwm_ExternClockFilterPrescale_t Prescale)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_CKFDIV_MASK;
    regValue |= Prescale << HWIO_EPWM11_CTL1_EPWM11_CTL1_CKFDIV_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetExternClockFilterDelay(Epwm_RegisterMap_t *const Module, Epwm_ExternClockFilterDelay_t Delay)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_CKDELAY_MASK;
    regValue |= Delay << HWIO_EPWM11_CTL1_EPWM11_CTL1_CKDELAY_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPMOD_MASK;
    regValue |= Mode << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPMOD_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetTrigEventEnablePhaseReload(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CTL1_EPWM11_CTL1_LPHSEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CTL1_EPWM11_CTL1_LPHSEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_ACTL_ADDR + offsetAddr);
    regValue &= ~0x3U << ((uint32_t)Event << 1U);
    regValue |= (uint32_t)Level << ((uint32_t)Event << 1U);
    REG_WRITE(offsetAddr + HWIO_EPWM11_ACTL_ADDR, regValue);
    // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const Epwm_OutputLevel_t Level)
{
    ...
    if (EPWM_OUTPUT_A == Output)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_ACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_ACTL_EPWM11_ACTL_ACTSFA_MASK;
        regValue |= Level << HWIO_EPWM11_ACTL_EPWM11_ACTL_ACTSFA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_ACTL_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_BCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_BCTL_EPWM11_BCTL_ACTSFB_MASK;
        regValue |= Level << HWIO_EPWM11_BCTL_EPWM11_BCTL_ACTSFB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_BCTL_ADDR, regValue);
        // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const Epwm_ForceConOutputLevel_t Level)
{
    ...
    if (EPWM_OUTPUT_A == Output)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_ACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_ACTL_EPWM11_ACTL_CSFA_MASK;
        regValue |= Level << HWIO_EPWM11_ACTL_EPWM11_ACTL_CSFA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_ACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else if (EPWM_OUTPUT_B == Output)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_BCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_BCTL_EPWM11_BCTL_CSFB_MASK;
        regValue |= Level << HWIO_EPWM11_BCTL_EPWM11_BCTL_CSFB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_BCTL_ADDR, regValue);
        // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (EPWM_OUTPUT_A == Output)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_ACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_ACTL_EPWM11_ACTL_OTSFA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_ACTL_EPWM11_ACTL_OTSFA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_ACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_BCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_BCTL_EPWM11_BCTL_OTSFB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_BCTL_EPWM11_BCTL_OTSFB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_BCTL_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL0_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0x1U << Mask;
    regValue |= (uint32_t)EnableStatus << Mask;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL0_ADDR, regValue);
    // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_UpdateReg_t UpdateReg, const Epwm_UpdateEvent_t UpdateEvent)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL0_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0x3U << Mask;
    regValue |= (uint32_t)UpdateEvent << Mask;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL0_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetIndependentUpdateEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL0_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL0_EPWM11_UDCTL0_GBUDEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_UDCTL0_EPWM11_UDCTL0_GBUDEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL0_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UR_MASK;
    regValue |= true << HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UR_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetUpdateEventMode(Epwm_RegisterMap_t *const Module, const Epwm_UpdateMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UDEVT_MASK;
    regValue |= true << HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UDEVT_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL1_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetUpdateEventEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL1_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UDEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_UDCTL1_EPWM11_UDCTL1_UDEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL1_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_CLDPRCS_MASK;
    regValue |= Scaler << HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_CLDPRCS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetCaptureEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SelectCaptureEvent(Epwm_RegisterMap_t *const Module, const bool CaptureEvent)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPSEL_MASK;
    regValue |= CaptureEvent << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetCaptureFilterEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPFEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CAPFEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetCaptureFilterPrescale(Epwm_RegisterMap_t *const Module, Epwm_CaptureFilterPrescale_t Prescale)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CFDIV_MASK;
    regValue |= Prescale << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CFDIV_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetCaptureFilterDelay(Epwm_RegisterMap_t *const Module, Epwm_CaptureFilterDelay_t Delay)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CAPCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CFDELAY_MASK;
    regValue |= Delay << HWIO_EPWM11_CAPCTL_EPWM11_CAPCTL_CFDELAY_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_DBCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_DBCTL_EPWM11_DBCTL_OUTMODE_MASK;
    regValue |= DeadOutput << HWIO_EPWM11_DBCTL_EPWM11_DBCTL_OUTMODE_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_DBCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetDeadZonePolarity(Epwm_RegisterMap_t *const Module, const Epwm_DeadPolarity_t DeadPolarity)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_DBCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_DBCTL_EPWM11_DBCTL_POLSEL_MASK;
    regValue |= DeadPolarity << HWIO_EPWM11_DBCTL_EPWM11_DBCTL_POLSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_DBCTL_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_DBT_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_DBT_EPWM11_DBT_FDBT_MASK;
    regValue |= DelayTime << HWIO_EPWM11_DBT_EPWM11_DBT_FDBT_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_DBT_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetDeadDelayTimeRise(Epwm_RegisterMap_t *const Module, const uint16_t DelayTime)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_DBT_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_DBT_EPWM11_DBT_RDBT_MASK;
    regValue |= DelayTime << HWIO_EPWM11_DBT_EPWM11_DBT_RDBT_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_DBT_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_PCCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PCCTL_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetFirstPulseWidthOfChopper(Epwm_RegisterMap_t *const Module, const Epwm_ChopperWidthFirst_t Width)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_PCCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_PCCTL_EPWM11_PCCTL_OSHTWTH_MASK;
    regValue |= Width << HWIO_EPWM11_PCCTL_EPWM11_PCCTL_OSHTWTH_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PCCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetPclkDutyCycle(Epwm_RegisterMap_t *const Module, const Epwm_ChopperPclkDuty_t PclkDuty)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_PCCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPDUTY_MASK;
    regValue |= PclkDuty << HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPDUTY_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PCCTL_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetPclkFrequency(Epwm_RegisterMap_t *const Module, const Epwm_ChopperPclkPrescale_t PclkFrequency)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_PCCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPFREQ_MASK;
    regValue |= PclkFrequency << HWIO_EPWM11_PCCTL_EPWM11_PCCTL_CHPFREQ_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PCCTL_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXAEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXAEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetAutoRestartEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXRSEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXRSEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetShutdownTzSource(Epwm_RegisterMap_t *const Module, Epwm_ShutdownSource_t Source)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_TZSEL_MASK;
    regValue |= Source << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_TZSEL_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetQeiErrorShutdownEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXQEIIFEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXQEIIFEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetClkErrorShutdownEnabled(Epwm_RegisterMap_t *const Module, const bool EnableStatus)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXCLKIFEN_MASK;
    regValue |= EnableStatus << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXCLKIFEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetTzShutdownMode(Epwm_RegisterMap_t *const Module, const Epwm_TzShutdownMode_t Mode)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_TZSCTL_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXTZEN_MASK;
    regValue |= Mode << HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXTZEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_TZSCTL_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
...
Epwm_LL_SetHiResOutputEnabled(Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRSELA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRSELA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRSELB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRSELB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
...
Epwm_LL_SetHiResDutyCycleEnabled(Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRDENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRDENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRDENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRDENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
...
Epwm_LL_SetHiResPeriodEnabled(Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRPENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRPENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRPENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRPENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRRENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRRENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRRENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRRENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
  ...
  Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRFENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRFENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRFENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRFENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
...
Epwm_LL_SetHiResPhaseEnabled(Epwm_RegisterMap_t *const Module, const Epwm_Output_t Output, const bool EnableStatus)
{
    ...
    if (Output == EPWM_OUTPUT_A)
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRACTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRPHSENA_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRACTL_EPWM11_HRACTL_HRPHSENA_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, regValue);
        // TODO: check if correct
    ...
    else
    {
        ...
        uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
        uint32_t regValue   = REG_READ(HWIO_EPWM11_HRBCTL_ADDR + offsetAddr);
        regValue &= ~HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRPHSENB_MASK;
        regValue |= EnableStatus << HWIO_EPWM11_HRBCTL_EPWM11_HRBCTL_HRPHSENB_SHFT;
        REG_WRITE(offsetAddr + HWIO_EPWM11_HRBCTL_ADDR, regValue);
        // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_HRRA_ADDR, Duty);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRDBUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_HRDB_EPWM11_HRDB_HRR_MASK;
    regValue |= Time << HWIO_EPWM11_HRDB_EPWM11_HRDB_HRR_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRDBUDEN_MASK, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetHiResDelayTimeFall(Epwm_RegisterMap_t *const Module, const uint8_t Time)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRDBUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_HRDB_EPWM11_HRDB_HRF_MASK;
    regValue |= Time << HWIO_EPWM11_HRDB_EPWM11_HRDB_HRF_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRDBUDEN_MASK, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_HRPHS_EPWM11_HRPHS_HRPRE_MASK;
    regValue |= Period << HWIO_EPWM11_HRPHS_EPWM11_HRPHS_HRPRE_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_MASK, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetHiResPhase(Epwm_RegisterMap_t *const Module, const uint8_t Phase)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_MASK;
    regValue |= Phase << HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRPHSUDEN_MASK, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRCFGUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_HRCFG_EPWM11_HRCFG_TIMS_MASK;
    regValue |= Value << HWIO_EPWM11_HRCFG_EPWM11_HRCFG_TIMS_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRCFGUDEN_MASK, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetHiResStepNum(Epwm_RegisterMap_t *const Module, const uint8_t Step)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRCFGUDEN_MASK + offsetAddr);
    regValue &= ~HWIO_EPWM11_HRCFG_EPWM11_HRCFG_STEP_MASK;
    regValue |= Step << HWIO_EPWM11_HRCFG_EPWM11_HRCFG_STEP_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_UDCTL2_EPWM11_UDCTL2_HRCFGUDEN_MASK, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return (uint8_t)(REG_BITS_READ(offsetAddr + HWIO_EPWM11_HRDELAY_ADDR, (0xFFU << Mask), Mask));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_ETCTL0_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0x1U << Mask;
    regValue |= (uint32_t)EnableStatus << Mask;

    REG_WRITE(offsetAddr + HWIO_EPWM11_ETCTL0_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_ETCTL1_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0x7U << Mask;
    regValue |= (uint32_t)Trigger << Mask;

    REG_WRITE(offsetAddr + HWIO_EPWM11_ETCTL1_ADDR, regValue);
    // TODO: check if correct
...
Epwm_LL_SetTriggerAdPeriod(Epwm_RegisterMap_t *const Module, const bool Event, const Epwm_TriggerADEventPeriod_t Period)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_ETCTL1_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0xFU << Mask;
    regValue |= (uint32_t)Period << Mask;
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return (REG_BITS_READ(offsetAddr + HWIO_EPWM11_ETCTL1_ADDR, 0xFU << Mask, Mask));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_BWCFG_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_BWCFG_EPWM11_BWCFG_BWIDTH_MASK;
    regValue |= Width << HWIO_EPWM11_BWCFG_EPWM11_BWCFG_BWIDTH_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_BWCFG_ADDR, regValue);
    // TODO: check if correct
...
KF_INLINE void Epwm_LL_SetBlankWindowOffset(Epwm_RegisterMap_t *const Module, const uint16_t Offset)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_BWCFG_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_BWCFG_EPWM11_BWCFG_BWOFFSET_MASK;
    regValue |= Offset << HWIO_EPWM11_BWCFG_EPWM11_BWCFG_BWOFFSET_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_BWCFG_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_BWCNT_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_BWCNT_EPWM11_BWCNT_OFFCNT_MASK;
    regValue = regValue >> HWIO_EPWM11_BWCNT_EPWM11_BWCNT_OFFCNT_SHFT;
...
KF_INLINE uint16_t Epwm_LL_GetBlankWindowWidth(Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_BWCNT_ADDR + offsetAddr);
    regValue &= HWIO_EPWM11_BWCNT_EPWM11_BWCNT_WITCNT_MASK;
    regValue = regValue >> HWIO_EPWM11_BWCNT_EPWM11_BWCNT_WITCNT_SHFT;
    return (uint16_t)(regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK + offsetAddr);
    regValue &= HWIO_EPWM11_STA_EPWM11_STA_DIR_MASK;
    regValue = regValue >> HWIO_EPWM11_STA_EPWM11_STA_DIR_SHFT;
    return (bool)(regValue);
    // TODO: check if correct
...
KF_INLINE bool Epwm_LL_GetCountReachMaxStatus(Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK + offsetAddr);
    regValue &= HWIO_EPWM11_STA_EPWM11_STA_CNTMAX_MASK;
    regValue = regValue >> HWIO_EPWM11_STA_EPWM11_STA_CNTMAX_SHFT;
    return (bool)(regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK, 2U);
    // TODO: check if correct
...
KF_INLINE bool Epwm_LL_GetSyncEventInputStatus(Epwm_RegisterMap_t *const Module)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK + offsetAddr);
    regValue &= HWIO_EPWM11_STA_EPWM11_STA_SYNCI_MASK;
    regValue = regValue >> HWIO_EPWM11_STA_EPWM11_STA_SYNCI_SHFT;
    return (bool)(regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK, 4U);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return (bool)(REG_BITS_READ(offsetAddr + HWIO_EPWM11_RST0_EPWM11_RST0_RSTSTA_MASK, (0x1U << Mask), Mask));
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_BWCNT_ADDR, Count);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_EPWM11_BWCNT_ADDR);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSEN_MASK, Phase);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_EPWM11_CTL0_EPWM11_CTL0_PHSEN_MASK);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PPX_ADDR, Period);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_EPWM11_PPX_ADDR);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_PRSC_ADDR, Scaler);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_EPWM11_PRSC_ADDR);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    REG_WRITE(offsetAddr + HWIO_EPWM11_HRACTL_ADDR, Value);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return REG_READ(offsetAddr + HWIO_EPWM11_CAPCTL_ADDR);
    // TODO: check if correct
...
KF_INLINE bool Epwm_LL_GetIntrFlag(const Epwm_RegisterMap_t *const Module, const Epwm_InterruptIndex_t IntIndex)
{
    ...
    return (bool)REG_BITS_READ(
      offsetAddr + HWIO_EPWM11_TZSCTL_EPWM11_TZSCTL_PXQEIIFEN_MASK, 1U << (uint32_t)IntIndex, (uint32_t)IntIndex);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_IE_ADDR + offsetAddr);
    regValue &= ~(uint32_t)0x1U << (uint32_t)IntIndex;
    regValue |= (uint32_t)EnableStatus << (uint32_t)IntIndex;
    REG_WRITE(offsetAddr + HWIO_EPWM11_IE_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_IC_ADDR + offsetAddr);
    regValue &= ~HWIO_EPWM11_IC_EPWM11_IC_CAPIC_MASK;
    regValue |= ClearMode << HWIO_EPWM11_IC_EPWM11_IC_CAPIC_SHFT;
    REG_WRITE(offsetAddr + HWIO_EPWM11_IC_ADDR, regValue);
    // TODO: check if correct
...
#ifdef SIMULATION
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    uint32_t regValue   = REG_READ(HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDEN_MASK + offsetAddr);
    regValue &= ~(uint32_t)0x1U << (uint32_t)DmaIndex;
    regValue |= (uint32_t)EnableStatus << (uint32_t)DmaIndex;
    REG_WRITE(offsetAddr + HWIO_EPWM11_CTL1_EPWM11_CTL1_BWINDEN_MASK, regValue);
    // TODO: check if correct
...
KF_INLINE bool Epwm_LL_GetDmaTriggeredFlag(Epwm_RegisterMap_t *const Module, const Epwm_InterruptIndex_t DmaIndex)
{
    ...
    uint32_t offsetAddr = ((uint32_t)((uintptr_t)Module)) & ~EPWM_MODULE_BASE_ADDR;
    return (bool)REG_BITS_READ(
      offsetAddr + HWIO_EPWM11_STA_EPWM11_STA_CADFUF_MASK, 1U << (uint32_t)DmaIndex, (uint32_t)DmaIndex);
    // TODO: check if correct
