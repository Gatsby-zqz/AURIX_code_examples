...
/* TODO: FPGA的RAM只有64K，因此仅使用32K作为任务栈空间 */
...
/*TODO: FPGA输入时钟20MHz，仿真使用100MHz*/
// #define configSTM_CLOCK_HZ           (configCPU_CLOCK_HZ / 3)
#define configSTM_CLOCK_HZ           (50000000U)
...
#define configMAX_SYSCALL_INTERRUPT_PRIORITY                                                                           \
    31 /* Interrupt above priority 64 are not effected by critical sections, but cannot call interrupt safe FreeRTOS   \
          functions. */
...
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() /* nothing */ /* default: use                                         \
                                                                  Tick counter                                         \
                                                                  as runtime                                           \
                                                                  counter */
